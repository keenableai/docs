...
<Steps>
    ...
    <Step title="Add provider credentials" icon="key">
        ...
        Use the `/auth` command to set API keys. See [Providers](/oss/javascript/deepagents/code/providers) for the full list and credential details.
    ...
    <Step title="Choose a model (optional)" icon="cpu">
        ...
        Use `/model --default provider:model` to persist your choice across sessions. See [Model providers](/oss/javascript/deepagents/code/providers) for the full provider list, open weights options, and credential details.
    </Step>
